	...
	<div class="page-wrapper">
		...
		<main class="page-content">
						...
						<form class="m-b30">
							<div class="mb-4">
								...
								<div class="input-group input-mini input-lg">
									<input type="email" id="email" class="form-control" value="info@examplegmail.com">
								</div>
							</div>
						</form>
					</div>
			...
			<div class="bottom-btn pb-3">
				<a href="otp-confirm.php" class="btn btn-thin btn-lg w-100 btn-primary rounded-xl">Send Mail</a>
