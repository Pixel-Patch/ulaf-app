...
<body class="bg-light">
	<div class="page-wrapper">
		...
		<header class="header header-fixed">
			<div class="header-content">
				...
				<div class="mid-content">
					<h4 class="title">Write Review</h4>
				</div>
			...
			<div class="container">
				<div class="dz-card list style-3 bg-white border-bottom">
					<div class="media-100 me-3">
						<a href="product-detail.php"><img class="rounded" src="assets/images/menus/menu1.jpg" alt=""></a>
					</div>
					<div class="dz-content">
						<div class="dz-head">
							<h6 class="title font-w500 max-100"><a href="product-detail.php">Brewed Cappuccino Latte with Creamy Milk</a></h6>
						</div>
						<ul class="tag-list">
				...
				<div class="write-reviews-box">
					<div class="rating-content">
						...
						<p class="dz-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
					</div>
					<div class="rating-info">
						<h3 class="rating-text">4.0</h3>
					...
					<div class="mb-3">
						<textarea class="form-control bg-white" name="notes" id="review" placeholder="Write your review here"></textarea>
					</div>
				</div>
			</div>
		</main>
		...
		<div class="footer fixed bg-transparent">
			<div class="container">
				<a href="reward.php" class="btn btn-primary rounded-xl btn-lg btn-thin w-100 gap-2">Send</a>
			</div>
		</div>
		<!-- Footer -->
