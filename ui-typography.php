...
<body>
    <div class="page-wrapper">
        ...
        <!-- Header -->
        <header class="header shadow bg-white header-fixed onepage">
                ...
                <div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
                    <div class="card-body">
                        ...
                        <div class="dz-content">
                            ...
                            <a href="ui-typography.html#contentArea" class="element-name scroll">Typography style</a>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <h6 class="mb-3">h6. Bootstrap heading</h6>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-4">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <address>
                                                ...
                                                <br>
                                                <a href="https://ombe.dexignzone.com/cdn-cgi/l/email-protection#785b"><span class="__cf_email__" data-cfemail="345d5a525b74514c55594458511a575b59">[email&nbsp;protected]</span></a>
                                            </address>
                                        </div>
                                    </div>
                                    <div class="col-12">
