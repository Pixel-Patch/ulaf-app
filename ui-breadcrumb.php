			...
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-breadcrumb.html#contentArea" class="element-name scroll">Breadcrumb style</a>
						</div>
				...
				<div class="row" id="contentArea">
							...
							<div class="px-3">
								<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 py-2 px-1">
										<li class="breadcrumb-item"><a href="ui-breadcrumb.html#">Home</a></li>
										<li class="breadcrumb-item"><a href="ui-breadcrumb.html#">Elements</a></li>
					...
					<div class="col-12 mb-3">
						...
						<div class="breadcrumb-wrapper dz-breadcrumb style-3" style="background-image: url('assets/images/background/bg.png');">
							<div class="px-3">
								<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 py-2 px-1">
										<li class="breadcrumb-item"><a href="ui-breadcrumb.html#">Home</a></li>
					...
					<div class="col-12 mb-3">
						<div class="breadcrumb-wrapper dz-breadcrumb my-1 bg-secondary">
							<div class="px-3">
								<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 py-2 px-1">
										<li class="breadcrumb-item"><a href="ui-breadcrumb.html#">Home</a></li>
					...
					<div class="col-12 mb-3">
						<div class="breadcrumb-wrapper dz-breadcrumb my-1 bg-success">
							<div class="px-3">
								<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 py-2 px-1">
										<li class="breadcrumb-item"><a href="ui-breadcrumb.html#">Home</a></li>
					...
					<div class="col-12 mb-3">
						<div class="breadcrumb-wrapper dz-breadcrumb my-1 bg-danger">
							<div class="px-3">
								<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 py-2 px-1">
										<li class="breadcrumb-item"><a href="ui-breadcrumb.html#">Home</a></li>
					...
					<div class="col-12 mb-3">
						<div class="breadcrumb-wrapper dz-breadcrumb my-1 bg-info">
							<div class="px-3">
								<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 py-2 px-1">
										<li class="breadcrumb-item"><a href="ui-breadcrumb.html#">Home</a></li>
					...
					<div class="col-12 mb-3">
						<div class="breadcrumb-wrapper dz-breadcrumb my-1 bg-warning">
							<div class="px-3">
								<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
									<ol class="breadcrumb mb-0 py-2 px-1">
										<li class="breadcrumb-item"><a href="ui-breadcrumb.html#">Home</a></li>
