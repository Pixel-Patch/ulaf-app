	...
	<div class="page-wrapper">
		...
		<header class="header header-fixed">
			<div class="header-content">
				<div class="mid-content" style="margin-left: 20px;">
		...
		<main class="page-content space-top p-b40">
			<div class="container pt-0">
				<div class="profile-area">
					<div class="author-bx">
						<div class="dz-media">
							<img src="assets/uploads/user-avatar/<?php echo htmlspecialchars($userData['Avatar_Image'] ?? 'default-avatar.jpg'); ?>" alt="">
						</div>
						<div class="dz-content" style="margin-top:-10px;";>
							<h2 class="name"><?php echo htmlspecialchars($userData['FullName'] ?? 'Unknown User'); ?></h2>
							<p class="text-primary"><?php echo htmlspecialchars($userData['College'] ?? 'Unknown College'); ?></p>
							<p><?php echo htmlspecialchars($userData['User_ID'] ?? 'Unknown ID Number'); ?></p>
						...
						<ul>
							<li>
								<div class="icon-bx">
									...
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#04764e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
										<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
										<circle cx="12" cy="7" r="4"></circle>
									</svg>
								</div>
								<div class="dz-content">
									<p class="sub-title">User Type</p>
									<h6 class="title"><?php echo htmlspecialchars($userData['Role'] ?? 'N/A'); ?></h6>
								</div>
							</li>
							<li>
								<div class="icon-bx">
								...
								<div class="dz-content">
									...
									<h6 class="title"><?php echo htmlspecialchars($userData['Contact'] ?? 'N/A'); ?></h6>
								</div>
							</li>
							<li>
								<div class="icon-bx">
								...
								<div class="dz-content">
									...
									<h6 class="title"><?php echo htmlspecialchars($userData['Email'] ?? 'N/A'); ?></h6>
								</div>
							</li>
							<li>
								<div class="icon-bx">
								...
								<div class="dz-content">
									...
									<h6 class="title"><?php echo htmlspecialchars($userData['CLSU_Address'] ?? 'N/A'); ?></h6>
								</div>
							</li>
