	...
	<div class="page-wrapper">
		...
		<main class="page-content space-top p-b80">
			<div class="container">
					...
					<ul class="dz-list-group radio style-2">
							...
							<label class="radio-label">
								...
								<div class="checkmark">
									...
									<div class="list-content">
										...
										<p class="active-status">456 Elm Avenue, Smallville, CA 98765</p>
									</div>
									<span class="check"></span>
								</div>
							</label>
						...
						<li class="list-group-items">
							<label class="radio-label">
								...
								<div class="checkmark">
									...
									<div class="list-content">
										<h6 class="title">Home Address</h6>
										<p class="active-status">789 Maple Lane, Suburbia, NY 54321</p>
									</div>
									<span class="check"></span>
								</div>
							</label>
						...
						<li class="list-group-items">
							<label class="radio-label">
								<input type="radio" name="radio2">
								<div class="checkmark">
									<div class="dz-icon style-2 icon-fill"><i class="fi fi-rr-shop font-20"></i></div>
									<div class="list-content">
										<h6 class="title">Shop Address</h6>
										<p class="active-status">654 Pine Road, Countryside, FL 34567</p>
									</div>
									<span class="check"></span>
								</div>
							</label>
				...
				<a href="add-delivery-address.php" class="dz-add-box">
		...
		<div class="footer-fixed-btn bottom-0 bg-white">
			<a href="checkout.php" class="btn btn-lg btn-thin btn-primary w-100 rounded-xl">Save Address</a>
		</div>
		<!-- Footer Fixed Button -->
	</div>
	<!--**********************************
