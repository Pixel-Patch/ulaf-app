			...
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-placeholder.html#contentArea" class="element-name scroll">Placeholder style</a>
						</div>
				...
				<div class="row" id="contentArea">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Animation placeholder</h5>
							</div>
							<div class="card-body">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Color placeholder</h5>
							</div>
							<div class="card-body">
								<span class="placeholder col-12"></span>
