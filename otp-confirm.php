			...
			<div class="container py-0">
				<div class="dz-authentication-area">
					...
					<div class="section-head text-center">
						...
						<p>An Authentication Code Has Sent To <span class="text-lowercase">info@examplegmail.com</span></p>
					</div>
					<div class="account-section">
						<form action="https://ombe.dexignzone.com/bootstrap/xhtml/submit">
						...
						<div class="text-center form-text">If you don’t receive code! <a href="javascript:void(0);" class="text-underline link">Resend</a></div>
					</div>
				</div>
			</div>
			<div class="bottom-btn pb-3">
				<a href="change-password.php" class="btn btn-thin btn-lg w-100 btn-primary rounded-xl">Verify and proceed</a>
				<div class="text-center mt-3 form-text">Back To <a href="sign-in.php" class="text-underline link">Sign In</a></div>
			</div>
		</main>
		<!-- Main Content End  -->
