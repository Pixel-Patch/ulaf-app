		...
		<header class="header header-sticky border-bottom">
			<div class="header-content">
				...
				<div class="right-content">
					<a href="index.php" class=""><i class="feather icon-home font-24"></i></a>
				</div>
			</div>
		</header>
		<!-- Header -->
				...
				<div class="default-tab style-2 mt-1">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item" role="presentation">
							<a class="nav-link active" data-bs-toggle="tab" href="my-order.html#home" aria-selected="true" role="tab">Ongoing</a>
						</li>
						<li class="nav-item" role="presentation">
							<a class="nav-link" data-bs-toggle="tab" href="my-order.html#profile" aria-selected="false" role="tab" tabindex="-1">Completed</a>
						</li>
					</ul>
									...
									<div class="dz-card list">
										...
										<div class="dz-content">
											...
											<ul class="dz-meta">
												...
												<li>
													<a href="track-order.php" class="btn btn-primary btn-xs font-13 btn-thin rounded-xl">Track Order</a>
												</li>
											</ul>
										</div>
									</div>
									...
									<div class="dz-card list">
										...
										<div class="dz-content">
											...
											<ul class="dz-meta">
												<li class="dz-price flex-1">$12.6</li>
												<li>
													<a href="review.php" class="btn btn-primary btn-xs font-13 btn-thin rounded-xl">Write Review</a>
												</li>
											</ul>
										</div>
									</div>
