				...
				<div class="edit-profile">
					<form id="profileForm" action="update-user-profile.php" method="POST" enctype="multipart/form-data">
						...
						<div class="mb-3">
							...
							<input type="text" id="addfullname" class="form-control" placeholder="John Doe" name="addfullname" aria-label="John Doe" value="<?php echo $itemData['Item_ID']; ?>" disabled />
						</div>
						<div class="mb-3">
