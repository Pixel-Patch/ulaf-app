		...
		<header class="header header-fixed">
			<div class="header-content">
				...
				<div class="mid-content">
					<h4 class="title">Tracking Orders</h4>
				</div>
		...
		<main class="page-content space-top">
			<div class="container">
				<div class="location-tracking">
					<!-- Map -->
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2484.4196734475977!2d-0.1453786231012505!3d51.48716571218091!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4876051d857f6e1f%3A0x8786bddd26e5d0bb!2sSt%20Gabriel&#39;s%20Church%20Hall!5e0!3m2!1sen!2sin!4v1705063156316!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					<div class="map-tooltip">
						<p class="mb-1">Estimated Time</p>
						<h5 class="time mb-0">5-10 min</h5>
					</div>
					<div class="dz-tracking">
						<div class="delivery-man bg-primary">
							<div class="inner-content">
								<div class="dz-media media-50 rounded-circle">
									<img src="assets/images/avatar/1.jpg" alt="">
								</div>
								<div class="dz-content">
									<h6 class="title">Mr. Shandy</h6>
									<p class="text-white">ID 2445556</p>
								</div>
								<div class="icon-area">
									<a href="tel:0123456789;" class="icon-cell">
										<i class="feather icon-phone"></i>
									</a>
									<a href="chat.php" class="icon-cell">
						...
						<div class="fixed-content">
							<ul class="dz-track-list">
								<li>
									...
									<div class="info">
										<h5 class="title">Sweet Corner St. </h5>
										<p>Franklin Avenue 2263</p>
									</div>
								</li>
								<li>
									<div class="icon-bx">
									...
									<div class="info">
										<h5 class="title">Ombe Coffee Shop</h5>
