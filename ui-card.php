		...
		<div class="page-content space-top">
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-card.html#contentArea" class="element-name scroll">Cards style</a>
						</div>
				...
				<div class="row" id="contentArea">
					<div class="col-12">
						<div class="card">
							<img src="assets/images/card/pic1.png" class="card-img-top" alt="...">
							<div class="card-body">
					...
					<div class="col-12">
						<div class="card">
							<img src="assets/images/card/pic2.png" class="card-img-top" alt="...">
							<div class="card-body">
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							</div>
						</div>
					...
					<div class="col-12">
						<div class="card">
							<img src="assets/images/card/pic3.png" class="card-img-top" alt="...">
							<div class="card-body">
								<h5 class="card-title">Card title</h5>
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							</div>
					...
					<div class="col-12">
						<div class="card text-center">
							...
							<div class="card-body">
								...
								<a href="ui-card.html#" class="btn btn-primary">Go somewhere</a>
							</div>
							<div class="card-footer">
								2 days ago
							</div>
