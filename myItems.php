...
<body class="bg-light">
	<div class="page-wrapper">
		...
		<header class="header header-fixed border-bottom">
			<div class="header-content">
				...
				<div class="right-content">
					<a href="add-delivery-address.php" class="icon btn btn-outline-primary btn-sm gap-1 p-2 rounded-xl">
				...
				<div class="dz-flex-box p-b100">
					<div class="dz-cart-list">
						...
						<div class="dz-content">
							<h6 class="title"><a href="product-detail.php">Hot Creamy Cappuccino Latte Ombe</a></h6>
							<ul class="dz-meta">
					...
					<div class="dz-cart-list">
						...
						<div class="dz-content">
							<h6 class="title"><a href="product-detail.php">Ice Chocolate Coffee</a></h6>
							<ul class="dz-meta">
		...
		<div class="footer-fixed-btn border-bottom">
			<a href="checkout.php" class="btn btn-lg btn-thin btn-primary w-100 gap-1 rounded-xl">Proceed to Buy <b> (8 items)</b></a>
		</div>
		<!-- Main Content End -->
