			...
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-list-group.html#contentArea" class="element-name scroll">List group style</a>
						</div>
				...
				<div class="row" id="contentArea">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header d-block">
								<h5 class="card-title">List Active Items</h5>
							</div>
							<div class="card-body">
								<ul class="list-group">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header d-block">
								<h5 class="card-title">List Disabled Items</h5>
							</div>
							<div class="card-body">
								<ul class="list-group">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="list-group">
									<a href="ui-list-group.html#" class="list-group-item list-group-item-action active" aria-current="true">
										The current link item
									</a>
									<a href="ui-list-group.html#" class="list-group-item list-group-item-action">A second link item</a>
									<a href="ui-list-group.html#" class="list-group-item list-group-item-action">A third link item</a>
									<a href="ui-list-group.html#" class="list-group-item list-group-item-action">A fourth link item</a>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="list-group">
									...
									<a href="ui-list-group.html#" class="list-group-item list-group-item-action">
										<div class="d-flex w-100 justify-content-between">
											<h6 class="mb-1">List group item heading</h6>
