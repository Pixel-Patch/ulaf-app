			...
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-radio.html#contentArea" class="element-name scroll">Radio style</a>
						</div>
				...
				<div class="row" id="contentArea">
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Square Radio</h5>
							</div>
							<div class="card-body">
								<div class="radio square-radio">
									<label class="radio-label">Radio button 01
										<input type="radio" checked="checked" name="radio1">
										<span class="checkmark"></span>
									</label>
									<label class="radio-label">Radio button 02
										<input type="radio" name="radio1">
										<span class="checkmark"></span>
									</label>
									<label class="radio-label">Radio button 03
										<input type="radio" name="radio1">
										<span class="checkmark"></span>
									</label>
									<label class="radio-label">Radio button 04
										<input type="radio" name="radio1">
										<span class="checkmark"></span>
									</label>
								</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Circle Radio</h5>
							</div>
							<div class="card-body">
