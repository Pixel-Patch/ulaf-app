...
<body class="bg-light">
	<div class="page-wrapper">
		...
		<main class="page-content space-top p-b80">
			<div class="container">
				<div class="title-bar">
					<h6 class="title font-w600">Credit/Debit Card</h6>
					<a href="add-card.php" class="d-flex align-items-center font-w500 gap-1"><i class="fi fi-rr-add font-16"></i>Add Card</a>
				</div>
										...
										<h5 class="card-title">
											<span class="activity">
												<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
													...
													<circle cx="10.0003" cy="10.0001" r="5.83333" stroke="#515151" />
												</svg>
											</span>
											Credit Card
										</h5>
									...
									<div class="card-info">
										...
										<div class="card-logo">
											<svg width="40" height="24" viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg">
												...
												<circle cx="28" cy="12" r="12" fill="white" fill-opacity="0.5" />
											</svg>
										</div>
									</div>
									<h5 class="card-number">**** **** **** 4532</h5>
				...
				<div class="accordion dz-accordion" id="accordionExample">
					<div class="accordion-item">
						<div class="accordion-header acco-select" id="headingOne">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
								...
								<span class="acco-title">Cash on Delivery(Cash/UPI)</span>
					...
					<div class="accordion-item">
						<div class="accordion-header acco-select" id="headingTwo">
							<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
								...
								<span class="acco-title">Google Pay/Phone Pay/BHIM UPI</span>
								<span class="checkmark"></span>
							</button>
						</div>
						<div id="collapseTwo" class="accordion-collapse collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								<div class="form-item mb-3">
									...
									<input type="text" class="form-control" placeholder="Enter your UPI ID" autocomplete="off" required="">
								</div>
								<a href="javascrpit:void(0);" class="btn btn-thin btn-primary rounded-xl btn-block mb-3">Continue</a>
								<div class="d-flex align-items-center">
									<div class="dz-icon me-2">
										<i class="fi fi-rr-shield-check font-24 text-success"></i>
									</div>
									<p class="mb-0 pe-3">Your UPI ID Will be encrypted and is 100% safe with us.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="accordion-item">
						<div class="accordion-header acco-select" id="headingThree">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
								<span class="dz-icon">
									<i class="fi fi-rr-folder"></i>
								</span>
								<span class="acco-title">Payments/Wallet</span>
								<span class="checkmark"></span>
							</button>
						</div>
						<div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								...
								<a href="javascript:void(0);" class="btn btn-thin btn-primary rounded-xl btn-block">Continue</a>
							</div>
						</div>
					</div>

					<div class="accordion-item">
						<div class="accordion-header acco-select" id="headingFour">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
								<span class="dz-icon">
									<i class="fi fi-rr-bank"></i>
								</span>
								<span class="acco-title">Netbanking</span>
								<span class="checkmark"></span>
							</button>
						</div>
						<div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								<button class="btn btn-primary rounded-xl btn-thin w-100" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Netbanking</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="footer-fixed-btn bottom-0 bg-white">
			<a href="checkout.php" class="btn btn-lg btn-thin rounded-xl btn-primary w-100">Continue</a>
		</div>
		<!-- Footer Fixed Button -->
				...
				<div class="offcanvas-body">
					<div class="card">
						<div class="card-header">
							<h6 class="card-title font-w500">Popular Banks</h6>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-4">
					...
					<h6 class="title-bar font-w500">All Banks</h6>
