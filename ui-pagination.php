...
<body>
	<div class="page-wrapper">
		...
		<!-- Page Content Start -->
		<div class="page-content space-top pagination-area">
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-pagination.html#contentArea" class="element-name scroll">Pagination style</a>
						</div>
				...
				<div class="row" id="contentArea">
						...
						<div class="card">
							...
							<div class="card-body">
								<nav aria-label="Page navigation example">
									<ul class="pagination">
										<li class="page-item"><a class="page-link" href="ui-pagination.html#">Previous</a></li>
										...
										<li class="page-item"><a class="page-link" href="ui-pagination.html#">Next</a></li>
									</ul>
								</nav>
							</div>
						</div>
									...
									<ul class="pagination">
										<li class="page-item">
											<a class="page-link" href="ui-pagination.html#" aria-label="Previous">
												<span aria-hidden="true"><i class="icon feather icon-chevron-left"></i></span>
											</a>
										</li>
										<li class="page-item"><a class="page-link" href="ui-pagination.html#">1</a></li>
										<li class="page-item"><a class="page-link" href="ui-pagination.html#">2</a></li>
										...
										<li class="page-item">
											<a class="page-link" href="ui-pagination.html#" aria-label="Next">
												<span aria-hidden="true"><i class="icon feather icon-chevron-right"></i></span>
											</a>
										</li>
									</ul>
								</nav>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Pagination Color</h5>
							</div>
							<div class="card-body">
								<nav>
