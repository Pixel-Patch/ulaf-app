...
<body>
    <div class="page-wrapper">
        ...
        <!-- Page Content Start -->
        <div class="page-content space-top dropdown-area">
            <div class="container">
                <div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
                    <div class="card-body">
                        ...
                        <div class="dz-content">
                            ...
                            <a href="ui-dropdown.html#contentArea" class="element-name scroll">Dropdowns style</a>
                        </div>
                ...
                <div class="row" id="contentArea">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-block">
                                <h5 class="card-title">Basic Dropdown</h5>
                                ...
                                <div class="basic-dropdown">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="ui-dropdown.html#">Link 1</a>
                                            <a class="dropdown-item" href="ui-dropdown.html#">Link 2</a>
                                            <a class="dropdown-item" href="ui-dropdown.html#">Link 3</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="basic-dropdown">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="ui-dropdown.html#">Another link</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-block">
                                <h5 class="card-title">Disable and Active items</h5>
                                <p class="m-0 subtitle">The
                                    <code>.dropdown-header</code> class is used to add headers inside the dropdown menu
                                </p>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-block">
                                <h5 class="card-title">Button Dropdowns</h5>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-block">
                                <h5 class="card-title">dropstart </h5>
                                <p class="m-0 subtitle">Trigger dropdown menus at the right of the elements by adding
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-dropdown text-end">
