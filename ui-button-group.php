			...
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-button-group.html#contentArea" class="element-name scroll">Button group style</a>
						</div>
				...
				<div class="row" id="contentArea">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Button Sizing</h5>
							</div>
							<div class="card-body">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Button Nesting</h5>
							</div>
							<div class="card-body">
								<div class="btn-group">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Vertical Dropdown Variation</h5>
							</div>
							<div class="card-body">
								<div aria-label="Vertical button group" role="group" class="btn-group-vertical">
									...
									<div role="group" class="btn-group">
										<button data-bs-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button" aria-expanded="false">Dropdown</button>
										<div class="dropdown-menu" style=""><a href="javascript:void(0);" class="dropdown-item">Dropdown link</a>
