			...
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-toast.html#contentArea" class="element-name scroll">Toasts style</a>
						</div>
				...
				<div class="row" id="contentArea">
							...
							<div class="card-body">
								<div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3982" data-bs-autohide="false">
									<div class="toast-header">
										...
										<button class="btn btn-close position-relative p-1" type="button" data-bs-dismiss="toast" aria-label="Close">
					...
					<div class="col-12">
						<div class="card">
							...
							<div class="card-body">
								<div class="card">
									<div class="card-header">
										<h5 class="card-title">Translucent Toast</h5>
									</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Different Color Toast</h5>
							</div>
							<div class="card-body">
								<div class="toast style-1 fade mb-2 show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3982" data-bs-autohide="false">
									<div class="toast-body">
										...
										<button class="btn btn-close position-absolute p-1" type="button" data-bs-dismiss="toast" aria-label="Close"><i class="icon feather icon-x"></i></button>
									</div>
								</div>
					...
					<div class="card">
						<div class="card-header">
							<h5 class="card-title">Live Toast</h5>
						</div>
						<div class="card-body">
							<button type="button" class="btn btn-primary btn-block mb-3 dzToastBtn" id="toastbtn1">Show live toast</button>
							<div id="dzToast1" class="dzToastArea toast style-1 toast-primary dz-toast on-bottom fade hide" role="alert" aria-live="polite" aria-atomic="true">
								<div class="toast-body">
									<svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd" d="M4.002 0a4 4 0 0 0-4 4v8a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4V4a4 4 0 0       0-4-4h-8zm1.06 12h3.475c1.804 0 2.888-.908 2.888-2.396 0-1.102-.761-1.916-1.904-2.034v-.1c.832-.14 1.482-.93 1.482-1.816 0-1.3-.955-2.11-2.542-2.11H5.062V12zm1.313-4.875V4.658h1.78c.973 0 1.542.457 1.542 1.237 0 .802-.604 1.23-1.764 1.23H6.375zm0 3.762h1.898c1.184 0 1.81-.48 1.81-1.377 0-.885-.65-1.348-1.886-1.348H6.375v2.725z"></path>
									</svg>
