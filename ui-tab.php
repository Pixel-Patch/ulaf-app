...
<body>
	<div class="page-wrapper">
		...
		<!-- Page Content Start -->
		<div class="page-content space-top element-area">
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-tab.html#contentArea" class="element-name scroll">Tabs style</a>
						</div>
				...
				<div class="row" id="contentArea">
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Default Tab</h5>
							</div>
							<div class="card-body">
								<!-- Nav tabs -->
								<div class="default-tab">
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item" role="presentation">
											<a class="nav-link active" data-bs-toggle="tab" href="ui-tab.html#home" aria-selected="true" role="tab"><i class="icon feather icon-home me-2"></i> Home</a>
										</li>
										<li class="nav-item" role="presentation">
											<a class="nav-link" data-bs-toggle="tab" href="ui-tab.html#profile" aria-selected="false" role="tab" tabindex="-1"><i class="icon feather icon-user me-2"></i>Profile</a>
										</li>
										<li class="nav-item" role="presentation">
											<a class="nav-link" data-bs-toggle="tab" href="ui-tab.html#contact" aria-selected="false" role="tab" tabindex="-1"><i class="icon feather icon-phone-call me-2"></i> Contact</a>
										</li>
										<li class="nav-item" role="presentation">
											<a class="nav-link" data-bs-toggle="tab" href="ui-tab.html#message" aria-selected="false" role="tab" tabindex="-1"><i class="icon feather icon-mail me-2"></i>Message</a>
										</li>
									</ul>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="custom-tab-1">
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item" role="presentation">
											<a class="nav-link" data-bs-toggle="tab" href="ui-tab.html#home1" aria-selected="false" role="tab" tabindex="-1"><i class="icon feather icon-home me-2"></i>Home</a>
										</li>
										<li class="nav-item" role="presentation">
											<a class="nav-link active" data-bs-toggle="tab" href="ui-tab.html#profile1" aria-selected="true" role="tab"><i class="icon feather icon-user me-2"></i>Profile</a>
										</li>
										<li class="nav-item" role="presentation">
											<a class="nav-link" data-bs-toggle="tab" href="ui-tab.html#contact1" aria-selected="false" role="tab" tabindex="-1"><i class="icon feather icon-phone-call me-2"></i> Contact</a>
										</li>
										<li class="nav-item" role="presentation">
											<a class="nav-link" data-bs-toggle="tab" href="ui-tab.html#message1" aria-selected="false" role="tab" tabindex="-1"><i class="icon feather icon-mail me-2"></i>Message</a>
										</li>
									</ul>
									<div class="tab-content">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Nav Pills Tabs</h5>
							</div>
							<div class="card-body">
