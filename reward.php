		...
		<main class="page-content space-top">
			<div class="container">
				<div class="rewards-box">
					<h5 class="sub-title">My Points<span class="icon-bx"><i class="feather icon-info"></i></span></h5>
					<h2 class="title">87,550</h2>
					<a href="javascript:void(0);" class="btn redeem-btn">Redeem Gift</a>
					<div class="bg-icon">
						<img src="assets/images/svg/rewards.svg" alt="images">
					</div>
				</div>
				<div class="title-bar">
					<h5 class="title">History Reward</h5>
				...
				<div class="rewards-list">
					<ul>
						<li>
							<div class="item-head">
								<h6 class="title">Extra Deluxe Gayo Coffee Packages</h6>
								<div class="dz-meta">
									<ul>
										<li>June 18, 2020</li>
										<li>4:00 AM</li>
						...
						<li>
							<div class="item-head">
								<h6 class="title">Buy 10 Brewed Coffee Packages</h6>
								<div class="dz-meta">
									<ul>
										<li>June 18, 2020</li>
										<li>4:00 AM</li>
							...
							<div class="pts-bx">
								<h4 class="points text-primary">+100</h4>
								<p>Pts</p>
							</div>
						</li>
						<li>
							<div class="item-head">
								<h6 class="title">Ice Coffee Morning</h6>
								<div class="dz-meta">
									<ul>
										<li>June 18, 2020</li>
										<li>4:00 AM</li>
						...
						<li>
							<div class="item-head">
								<h6 class="title">Hot Blend Coffee with Morning Cakes</h6>
								<div class="dz-meta">
									<ul>
										<li>June 18, 2020</li>
										<li>4:00 AM</li>
