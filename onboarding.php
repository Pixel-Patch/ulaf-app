...
<body>
	<div class="page-wrapper">
		...
		<!-- splash -->
		<div class="loader-screen" id="splashscreen" style="background-image: url('assets/images/background/bg1.jpg');">
			...
			<div class="container p-0">
				<div class="welcome-area">
							...
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="slide-info">
										<div class="dz-media">
											<img src="assets/images/svg/illustration.svg" alt="">
										</div>
										<div class="slide-content">
											<h3 class="dz-title" data-swiper-parallax="-300">Let’s meet our summer coffee drinks</h3>
											<p data-swiper-parallax="-100">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
										</div>
									</div>
								</div>
								<div class="swiper-slide">
									<div class="slide-info">
										<div class="dz-media">
											<img src="assets/images/svg/coffee-mug.svg" alt="">
										</div>
										<div class="slide-content">
											<h3 class="dz-title" data-swiper-parallax="-300">Start your morning with great coffee</h3>
											<p data-swiper-parallax="-100">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
										</div>
									</div>
								</div>
								<div class="swiper-slide">
									<div class="slide-info">
										<div class="dz-media">
											<img src="assets/images/svg/coffee-cup.svg" alt="">
										</div>
										<div class="slide-content">
											<h3 class="dz-title" data-swiper-parallax="-300">Best coffee shop in this town</h3>
											<p data-swiper-parallax="-100">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
										</div>
									</div>
								</div>
					...
					<div class="bottom-btn">
						<a href="welcome.php" class="btn btn-thin rounded-xl text-uppercase btn-lg w-100 btn-primary">Get Started</a>
					</div>
				</div>
			</div>
		</main>
