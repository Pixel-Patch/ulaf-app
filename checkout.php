...
<body class="bg-light">
	<div class="page-wrapper full-height">
					...
					<div class="dz-list m-b20">
						<ul class="dz-list-group">
							<li class="list-group-items">
								<a href="delivery-address.php" class="item-link">
							...
							<li class="list-group-items">
								<a href="payment.php" class="item-link">
		...
		<div class="footer-fixed-btn bottom-0 bg-white">
			<a href="my-order.php" class="btn btn-lg btn-thin btn-primary w-100 rounded-xl">Submit Order</a>
		</div>
		<!-- Footer Fixed Button -->
	</div>
	<!--**********************************
