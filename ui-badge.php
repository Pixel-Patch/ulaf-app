...
<body>
	<div class="page-wrapper">
		...
		<!-- Page Content Start -->
		<div class="page-content space-top badge-demo">
			<div class="container">
				<div class="card dz-card-box style-1" style="background-image: url('assets/images/bg-shape.png');">
					<div class="card-body">
						...
						<div class="dz-content">
							...
							<a href="ui-badge.html#contentArea" class="element-name scroll">Badges style</a>
						</div>
				...
				<div class="row" id="contentArea">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Badges Light</h5>
							</div>
							<div class="card-body">
								<div class="bootstrap-badge">
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Badges Size</h5>
							</div>
							<div class="card-body">
								<div class="bootstrap-badge">
									<span class="badge badge-xs badge-primary">xs</span>
									<span class="badge badge-sm badge-secondary">sm</span>
									<span class="badge badge-danger">md</span>
									<span class="badge badge-lg badge-success">lg</span>
									<span class="badge badge-xl badge-warning">xl</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title">Link Badge</h5>
							</div>
							<div class="card-body">
								<div class="bootstrap-badge">
