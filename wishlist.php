			...
			<div class="header-content">
				<div class="left-content">
					<div class="dz-head-items">
						<h5 class="title mb-0">Wishlist</h5>
						<ul class="dz-meta">
				...
				<div class="right-content">
					<a href="search.php" class="icon font-20">
			...
			<div class="container">
				<div class="row g-3">
						...
						<div class="dz-wishlist-bx">
							...
							<div class="dz-info">
								<div class="dz-head">
									...
									<p>Variant : White Stripes</p>
								</div>
								<ul class="dz-meta">
									<li class="price flex-1">$69.4</li>
									<li>
					...
					<div class="col-12 col-sm-6">
						<div class="dz-wishlist-bx">
							<div class="dz-media">
								<a href="product-detail.php"><img src="assets/images/menus/pic2.jpg" alt=""></a>
							</div>
							<div class="dz-info">
								<div class="dz-head">
									<h6 class="title"><a href="product-detail.php">Hot Coppuccino Latte with Mocha</a></h6>
									<p>Variant : White Stripes</p>
								</div>
								<ul class="dz-meta">
									<li class="price flex-1">$69.4</li>
					...
					<div class="col-12 col-sm-6">
						<div class="dz-wishlist-bx">
							<div class="dz-media">
								<a href="product-detail.php"><img src="assets/images/menus/pic3.jpg" alt=""></a>
							</div>
							<div class="dz-info">
								<div class="dz-head">
									<h6 class="title"><a href="product-detail.php">Hot Coppuccino Latte with Mocha</a></h6>
					...
					<div class="col-12 col-sm-6">
						<div class="dz-wishlist-bx">
							<div class="dz-media">
								<a href="product-detail.php"><img src="assets/images/menus/pic5.jpg" alt=""></a>
							</div>
							<div class="dz-info">
								<div class="dz-head">
